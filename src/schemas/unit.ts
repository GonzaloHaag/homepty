...
export const SchemaUnit = yup.object({
  ...
  id_estado_unidad: yup.number().integer().required("Campo obligatorio"),
  id_ciudad_unidad: yup.number().integer().required("Campo obligatorio"),
...
export const SchemaUnitProperty = yup.object({
  ...
  id_propiedad: yup.number().integer().nullable(),
  amenidades: yup.array(yup.number().integer()).nullable(),
  id_estado_unidad: yup.number().integer().nullable(),
  id_ciudad_unidad: yup.number().integer().nullable(),
